...
with hero_left:
    st.markdown(
        ...
        <section class="hero">
          ...
          <h1>Genuka Giyon</h1>
          <p class="hero-line">Robotics, AI, and embedded systems built for the real world.</p>
          <p class="hero-copy">
...
with about_right:
    st.markdown(
        ...
        <p class="body-large">
          I want to build things, see them work, and use engineering to make life easier through smarter,
          cleaner, more useful systems. My direction is robotics, AI systems, embedded control, computer vision,
